...
import Update from "./CompanyEdit";
import Show from "./CompanyShow";
...
const List = () => {
  ...
  const onEditSubmit = (form) => {
    ...
    api.put(variables.api.update.replace("{id}",editId),getFormData(form,editId)).then(res => {
  ...
  return (
    <React.Fragment>
      ...
      <Content>
        ...
        <Update view={view} uploading={uploading} onFormCancel={onFormCancel} handleSubmit={handleSubmit} onInputChange={onInputChange} register={register} formData={formData} errors={errors} onEditSubmit={onEditSubmit} onCategoryChange={onCategoryChange}/>
        
        <Show view={view} onFormCancel={onFormCancel} formData={formData}/>
        <Add view={view} uploading={uploading} handleSubmit={handleSubmit} onFormCancel={onFormCancel} onFormSubmit={onFormSubmit} onInputChange={onInputChange} register={register} formData={formData} errors={errors}  onCategoryChange={onCategoryChange}/>
