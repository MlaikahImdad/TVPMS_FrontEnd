...
const ReactDataTable = ({
  ...
  useEffect(() => {
    const changeTableHeight = () => {
      ...
      let extraHeight = window.screen.height - (header.scrollHeight + footer.scrollHeight + 300);
      
  
      
      // setHeight(dataTable.scrollHeight + extraHeight + "px");
      setHeight(extraHeight + "px");

      // console.log("Extra Height",extraHeight, "DataTable Height", dataTable.scrollHeight)
      if (data.length > 0) {
        document.querySelector(".rdt_Table").style.minHeight = "200px";
      } else {
        document.querySelector(".rdt_Table").style.minHeight = "0px";
      }
    };
    changeTableHeight()
